...
class New_Entry:
        def __init__(self,new_window,con):
            ...
            self.job_title.grid(row=3,column=0,sticky=W)

            self.location = Label(new_window,text = self.column_headers[4])
            self.location.grid(row=4,column=0,sticky=W)

            self.salary = Label(new_window,text = self.column_headers[5])
            self.salary.grid(row=5,column=0,sticky=W)
            ...
            self.job_num_entry.grid(row=0,column=1,sticky=W,pady=10)
        ...
        #Enter button and close window button
            ...
            self.new_btn_enter.grid(row=7,column=1,sticky=E)
            self.new_btn_close_win = Button(new_window,text="Close Window", command=new_window.destroy)
            self.new_btn_close_win.grid(row=7,column=0,sticky=W)
...
#
        def Enter_job(self):
            ...
            self.entered = Label(self.new_window,text="Row entered succesfully")
            self.entered.grid(row=6,column=0, columnspan=2)
