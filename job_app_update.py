...
class Job_App_Update:
    def __init__ (self,new_window,con):
        ...
        self.drop_jobapp.grid(row=2,column=0,sticky=W,pady=10)
    ...
    def Enter_update(self):
        ...
        query = "UPDATE job_app SET {} = '{}' WHERE Job_number='{}'".format(column_head,update,job_number)

        self.cur.execute(query)
        
        self.con.commit()

        self.entered = Label(self.new_window,text="Job application {} succesfully updated {} in Job application table".format(job_number,column_head),pady=10)
