...
class Update_tables:
    def __init__ (self,new_window,con,column_headers,type_input,table_name,table_title_name):
        ...
        self.table_title_name = table_title_name

        new_window.iconbitmap('images/database.ico')
        new_window.title('Update entry: {}'.format(table_title_name))
    ...
    def Enter_update(self):
        ...
        query = "UPDATE {} SET {} = '{}' WHERE Job_number='{}'".format(table_name,column_head,update,job_number)
